...
export class HardwareCategoryController {
  ...
  async createCategory(req: Request, res: Response): Promise<void> {
    ...
    try {
      const category = await this.hardwareCategoryService.createCategory(name, parentId)
      res.json(category)
    } catch (error) {
  ...
  async updateCategory(req: Request, res: Response): Promise<void> {
    ...
    try {
      const category = await this.hardwareCategoryService.updateCategory(parseInt(id), name, parentId)
      res.json(category)
    } catch (error) {
      res.status(400).json({ message: error.message })
    }
  ...
  async deleteCategory(req: Request, res: Response): Promise<void> {
    ...
    try {
      const categories = await this.hardwareCategoryService.deleteCategory(parseInt(id))
      res.json(categories)
    } catch (error) {
      res.status(400).json({ message: error.message })
    }
